...
def _ensemble_parse_(tfrecord):
    ...
    return (loaded_HSI_image, example['elevation'], example['height'], one_hot_sites, one_hot_domains), (one_hot_labels, one_hot_labels, one_hot_labels, one_hot_labels,one_hot_labels,one_hot_labels,one_hot_labels)
